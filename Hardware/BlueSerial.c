...
char BlueSerial_RxPacket[100];		//定义接收数据包数组，数据包格式"[MSG]"
...
void BlueSerial_Init(void)
{
	...
	USART_InitStructure.USART_BaudRate = 115200;            //波特率，提升至115200降低数据延迟
	...
	/*NVIC中断分组*/
	/*NVIC_PriorityGroupConfig 已在 main 函数中统一配置，此处不再重复调用*/
