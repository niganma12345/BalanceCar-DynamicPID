...
void MyI2C_W_SCL(uint8_t BitValue)
{
	...
	/*I2C 时序延时，确保 SCL 频率不超过 MPU6050 的 400kHz 上限*/
	/*72MHz 主频下延时约 2us，使 I2C 速率稳定在约 250kHz*/
	/*若不延时，I2C 速率可能达 MHz 级别，超出 MPU6050 规格，导致通信异常*/
	volatile uint8_t _i;
	for (_i = 0; _i < 25; _i++);
}
...
void MyI2C_W_SDA(uint8_t BitValue)
{
	...
	/*I2C 数据建立时间延时，确保 SDA 在 SCL 变化前稳定建立*/
	volatile uint8_t _i;
	for (_i = 0; _i < 8; _i++);
}
